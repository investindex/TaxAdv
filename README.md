...
Once you have maxed out employer matching in a given year, you can continue your own contributions up to a legal limit. Not all employer contributions are matching contributions. Some employers make fixed contributions regardless of employee contributions. The [403(b)](https://www.investopedia.com/terms/1/403bplan.asp) account is a close relative to the 401(k) account; one major difference is that employer contributions often vest immediately. 403(b) plans are for nonprofits like universities and university-owned hospitals. Work retirement accounts use an [automatic investment plan](https://www.investopedia.com/terms/a/automaticinvestmentplan.asp), in which an employee decides on an amount to be deducted from each paycheck (or a percentage of the paycheck). This deduction is automatically contributed to the account and invested in the employee's chosen allocation.

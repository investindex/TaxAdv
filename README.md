...
When performing a rollover from an employer plan to an IRA, you'll generally want to avoid any tax implications. To avoid a taxable event, you would roll over a traditional 401(k) account to a traditional IRA, or a Roth 401(k) account to a Roth IRA. You can also open a rollover IRA, which would make it easier to roll that money into a new employer's plan. The paragraph above described why this is not ideal for most people. If you plan to keep the money in an IRA, you can roll over the money to a traditional or Roth IRA. The IRA may already have money in it, if you've made prior contributions.

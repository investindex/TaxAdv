...
For most people, the normal contribution limits for a work retirement plan are not a restriction. $20,500 is already more than they can save for retirement in a year. But for those with high income or wealth who want to contribute even more money to a Roth account, you can learn about [mega backdoor Roth contributions](https://www.nerdwallet.com/article/investing/mega-backdoor-roths-work).
...
A [donor-advised fund](https://www.nerdwallet.com/article/taxes/donor-advised-funds) enables tax-exempt investing for charitable donations. Contributions to a DAF are tax-deductible to the same degree that direct donations would be. Once you contribute the money to your DAF, that money is no longer yours to spend. It's legally destined for IRS-qualified 501(c)(3) organizations. But you can invest the money before gifting it to a charity, with few restrictions. Due to the [fees](https://www.nerdwallet.com/article/taxes/donor-advised-funds) charged by DAF sponsors like Fidelity and Schwab's non-profit arms, I suggest that your initial contribution to a DAF should be at least $15,000. A $300 DAF would be eaten alive by fees, so unfortunately those who can't afford to donate large amounts should not use a DAF.

Tactics for increasing your tax deductions from charitable donations are [discussed in the section on taxes](https://github.com/investindex/Taxes#charity).
